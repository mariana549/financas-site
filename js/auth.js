...
async function handleForgotPwd() {
  ...
  // Sempre redireciona para produção — preview pode ter proteção Vercel
  const resetOrigin = window.location.hostname === 'localhost'
    ? window.location.origin
    : 'https://financas-site-six.vercel.app';
...
async function handleRecoveryPwd() {
  ...
  showMsg('recoveryMsg', '✓ Senha alterada com sucesso! Redirecionando para o login...', 'ok');
  setTimeout(async () => {
