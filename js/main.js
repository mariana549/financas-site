    ...
    if (isIOS) {
      banner.innerHTML = `
        ...
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:14px">
          ...
          <div>
            <div style="font-size:14px;font-weight:700;color:var(--text);line-height:1.3">Adicione o app à sua tela de início</div>
            <div style="font-size:12px;color:var(--text2);margin-top:3px;line-height:1.4">Assim fica igual a um aplicativo normal — com ícone na tela e acesso rápido</div>
          </div>
        </div>

        <div style="background:var(--bg3);border-radius:10px;padding:12px 14px;display:flex;flex-direction:column;gap:10px">
          <div style="display:flex;align-items:flex-start;gap:10px">
            <div style="width:24px;height:24px;border-radius:6px;background:var(--accent);color:#000;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;flex-shrink:0;margin-top:1px">1</div>
            <div style="font-size:13px;color:var(--text);line-height:1.5">
              Toque no botão de compartilhar do Safari — é esse ícone aqui:
              <span style="display:inline-flex;align-items:center;gap:2px;vertical-align:middle;background:var(--bg2);border:1px solid var(--border);border-radius:6px;padding:2px 7px;margin-left:2px">
                ...
                <span style="font-size:11px;font-weight:600">Compartilhar</span>
              </span>
              <br><span style="font-size:11px;color:var(--text3)">(fica na barra inferior ou superior do Safari)</span>
            </div>
          </div>
          <div style="height:1px;background:var(--border)"></div>
          <div style="display:flex;align-items:flex-start;gap:10px">
            <div style="width:24px;height:24px;border-radius:6px;background:var(--accent);color:#000;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;flex-shrink:0;margin-top:1px">2</div>
            <div style="font-size:13px;color:var(--text);line-height:1.5">
              Role a lista e toque em <strong style="color:var(--accent)">"Adicionar à Tela de Início"</strong>
              <br><span style="font-size:11px;color:var(--text3)">(pode precisar rolar um pouco para encontrar)</span>
            </div>
          </div>
          <div style="height:1px;background:var(--border)"></div>
          <div style="display:flex;align-items:flex-start;gap:10px">
            <div style="width:24px;height:24px;border-radius:6px;background:var(--accent);color:#000;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;flex-shrink:0;margin-top:1px">3</div>
            <div style="font-size:13px;color:var(--text);line-height:1.5">
              Toque em <strong>"Adicionar"</strong> no canto superior direito
              <br><span style="font-size:11px;color:var(--text3)">O ícone do app vai aparecer na sua tela de início ✓</span>
            </div>
          </div>
        </div>`;
    } else {
